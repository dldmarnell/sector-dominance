...
class MCSimulation:
    ...
    def plot_simulation(self):
        ...
        return self.simulated_return.plot(legend=None,title=plot_title,figsize=(15,10))
    ...
    def plot_distribution(self):
        ...
        plt = self.simulated_return.iloc[-1, :].plot(kind='hist', bins=10,density=True,title=plot_title, figsize=(15,10))
